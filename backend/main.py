...
from backend.routers import ga_performance
from backend.routers import amc_performance
from backend.routers import gold
from backend.routers import data_lake
from backend.routers import treasury
from backend.routers import cashflow
from backend.routers import close
...
app.include_router(ga_performance.router)  # /api/v1/ga/...
app.include_router(amc_performance.router) # /api/v1/amc/...
app.include_router(gold.router)            # /api/v1/gold/...
app.include_router(data_lake.router)      # /api/v1/data-lake/...
app.include_router(treasury.router)      # /api/v1/treasury/...
app.include_router(cashflow.router)      # /api/v1/cashflow/...
app.include_router(close.router)         # /api/v1/close/...
